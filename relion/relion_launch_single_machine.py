...
def setupParserOptions():
        ...
        parser.set_usage("This program will start a virtual machine on AWS to run RELION, syncing all contents of the current directory to AWS")
        parser.add_option("--instance",dest="instance",type="string",metavar="Instance",default='m4.4xlarge',
                    help="Instance type on AWS (Default=g3.16xlarge)")
...
if __name__ == "__main__":
	...
	print '\nLaunching instance %s on AWS for RELION (will take 2 - 5 minutes)...' %(instance)
	...
	#Edit .bashrc file to have automatic cd into RELION directory
	print "\n\n\n"
	print "Your RELION instance is ready to use! In order to use this machine:"
	...
	print '\n4. When finished with RELION on AWS, log out of terminal by typing:'
	print '$ exit'
	print '$ relion_terminate.py'
