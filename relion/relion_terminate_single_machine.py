...
if not os.path.exists('.instanceIDlist.txt'): 
	print '\nCannot terminate instance - could not find file .instanceIDlist.txt. Did you launch RELION on AWS from this directory?\n'
	sys.exit()
if not os.path.exists('.instanceIPlist.txt'):
        print '\nCannot terminate instance - could not find file .instanceIPlist.txt. Did you launch RELION on AWS from this directory?\n'
        sys.exit()
